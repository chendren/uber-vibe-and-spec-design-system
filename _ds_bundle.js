/* @ds-bundle: {"format":3,"namespace":"UberVibeAndSpecDesignSystem_37e707","components":[{"name":"Logo","sourcePath":"components/brand/Logo.jsx"},{"name":"Terminal","sourcePath":"components/content/Terminal.jsx"},{"name":"Badge","sourcePath":"components/core/Badge.jsx"},{"name":"Card","sourcePath":"components/core/Card.jsx"},{"name":"Kbd","sourcePath":"components/core/Kbd.jsx"},{"name":"Callout","sourcePath":"components/feedback/Callout.jsx"},{"name":"Button","sourcePath":"components/forms/Button.jsx"},{"name":"Input","sourcePath":"components/forms/Input.jsx"}],"sourceHashes":{"components/brand/Logo.jsx":"def14648d155","components/content/Terminal.jsx":"d98d629514a5","components/core/Badge.jsx":"6c5f2d12958d","components/core/Card.jsx":"22fff02019a3","components/core/Kbd.jsx":"f5e7dac97fa4","components/ds-card-boot.js":"1817d5d51f16","components/feedback/Callout.jsx":"92da6bfd8b47","components/forms/Button.jsx":"1bf860e78dd3","components/forms/Input.jsx":"4c4daec3a830","ui_kits/website/Curriculum.jsx":"140223b970f0","ui_kits/website/EnrollModal.jsx":"6b399e2d80fe","ui_kits/website/Footer.jsx":"a9adb64c1e7f","ui_kits/website/Header.jsx":"88ca66ab632f","ui_kits/website/Hero.jsx":"4cc7dbf076c2","ui_kits/website/Pricing.jsx":"deb4b78c3921","ui_kits/website/Quote.jsx":"cd109df3440f","ui_kits/website/Thesis.jsx":"5a44826c9e80","ui_kits/website/app.jsx":"90f2de1883fa","workshop/deck-stage.js":"9436a2deeb46","workshop/tweaks-panel.jsx":"6591467622ed"},"inlinedExternals":[],"unexposedExports":[]} */

(() => {

const __ds_ns = (window.UberVibeAndSpecDesignSystem_37e707 = window.UberVibeAndSpecDesignSystem_37e707 || {});
...
function Logo({
  ...
  // mark height in px
  theme = 'light',
  // 'light' | 'dark' — wordmark text color
  className = '',
  style = {},
  ...rest
}) {
  ...
  }, "Uber Vibe"), /*#__PURE__*/React.createElement("span", {
    style: {
...
function useStyles() {
  React.useEffect(() => {
    if (injected || document.getElementById('uvs-term-css')) {
      injected = true;
      return;
    }
...
function Terminal({
  ...
  return /*#__PURE__*/React.createElement("div", _extends({
    className: ['uvs-term', className].filter(Boolean).join(' ')
  }, rest), showChrome && /*#__PURE__*/React.createElement("div", {
    className: "uvs-term__bar"
  }, /*#__PURE__*/React.createElement("span", {
    className: "uvs-term__dot",
    style: {
    ...
    className: "uvs-term__title"
  }, title)), /*#__PURE__*/React.createElement("div", {
    className: "uvs-term__body"
  }, lines.map((l, i) => {
    const kind = l.kind || 'output';
    if (kind === 'cmd' || kind === 'command') {
      return /*#__PURE__*/React.createElement("div", {
        className: "uvs-term__line",
        key: i
      }, /*#__PURE__*/React.createElement("span", {
        className: "uvs-term__prompt"
      }, prompt), /*#__PURE__*/React.createElement("span", {
        className: "uvs-term__cmd"
      }, l.text));
    }
    return /*#__PURE__*/React.createElement("div", {
      className: `uvs-term__${kind}`,
      key: i
    }, l.text);
  }), cursor && /*#__PURE__*/React.createElement("span", {
    className: "uvs-term__cursor"
  })));
}
...
function useStyles() {
  React.useEffect(() => {
    if (injected || document.getElementById('uvs-badge-css')) {
      injected = true;
      return;
    }
    const el = document.createElement('style');
...
function Badge({
  variant = 'neutral',
  // clay | teal | neutral | success | warning | danger | solid
  dot = false,
  mono = false,
  className = '',
  children,
...
function useStyles() {
  React.useEffect(() => {
    if (injected || document.getElementById('uvs-card-css')) {
      injected = true;
      return;
    }
    const el = document.createElement('style');
...
function Card({
  ...
  useStyles();
  const cls = ['uvs-card', variant !== 'default' ? `uvs-card--${variant}` : '', interactive ? 'uvs-card--interactive' : '', className].filter(Boolean).join(' ');
  return /*#__PURE__*/React.createElement("div", _extends({
    className: cls
  }, rest), eyebrow && /*#__PURE__*/React.createElement("div", {
    className: "uvs-card__eyebrow"
  }, eyebrow), title && /*#__PURE__*/React.createElement("h3", {
    className: "uvs-card__title"
  }, title), children && /*#__PURE__*/React.createElement("div", {
    className: "uvs-card__body"
  }, children));
}
...
function useStyles() {
  React.useEffect(() => {
    if (injected || document.getElementById('uvs-kbd-css')) {
      injected = true;
      return;
    }
    const el = document.createElement('style');
...
function Kbd({
  ...
  return /*#__PURE__*/React.createElement("span", _extends({
    className: ['uvs-kbd', className].filter(Boolean).join(' ')
  }, rest), items.map((k, i) => /*#__PURE__*/React.createElement(React.Fragment, {
    key: i
  }, i > 0 && /*#__PURE__*/React.createElement("span", {
    className: "uvs-kbd__plus"
  }, "+"), /*#__PURE__*/React.createElement("kbd", {
    className: "uvs-kbd__key"
  }, k))));
}
Object.assign(__ds_scope, { Kbd });
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/Kbd.jsx", error: String((e && e.message) || e) }); }

// components/ds-card-boot.js
try { (() => {
...
(function () {
  ...
  var FILES = ['components/brand/Logo.jsx', 'components/forms/Button.jsx', 'components/forms/Input.jsx', 'components/core/Badge.jsx', 'components/core/Card.jsx', 'components/core/Kbd.jsx', 'components/feedback/Callout.jsx', 'components/content/Terminal.jsx'];
  ...
  async function ensureNS(rootRel) {
    ...
    for (var i = 0; i < FILES.length; i++) {
      ...
      s = s.replace(/import\s+React\s+from\s+['"]react['"];?/g, '').replace(/export\s+function/g, 'function');
      var names = [].concat.apply([], [...s.matchAll(/function\s+([A-Z]\w+)\s*\(/g)].map(m => [m[1]]));
      s += '\n' + names.map(n => 'window.' + NS + '.' + n + '=' + n + ';').join('\n');
      new Function('React', Babel.transform(s, {
        presets: ['react']
      }).code)(React);
    }
  }
  window.__bootCard = function (rootRel) {
    ensureNS(rootRel || '../../').then(function () {
      whenReady(function () {
        if (window.__mount) window.__mount();
      });
    }).catch(function (e) {
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/ds-card-boot.js", error: String((e && e.message) || e) }); }
...
function useStyles() {
  React.useEffect(() => {
    if (injected || document.getElementById('uvs-callout-css')) {
      injected = true;
      return;
    }
    const el = document.createElement('style');
    el.id = 'uvs-callout-css';
    el.textContent = CSS;
    document.head.appendChild(el);
    injected = true;
  }, []);
...
function Callout({
  variant = 'info',
  // info | tip | success | warning | danger
  icon = null,
  title = null,
  className = '',
  children,
  ...
  useStyles();
  return /*#__PURE__*/React.createElement("div", _extends({
    className: ['uvs-callout', `uvs-callout--${variant}`, className].filter(Boolean).join(' ')
  }, rest), icon && /*#__PURE__*/React.createElement("span", {
    className: "uvs-callout__icon"
  }, icon), /*#__PURE__*/React.createElement("div", {
    className: "uvs-callout__body"
  }, title && /*#__PURE__*/React.createElement("p", {
    className: "uvs-callout__title"
...
function useStyles() {
  React.useEffect(() => {
    if (injected || document.getElementById('uvs-btn-css')) {
      injected = true;
      return;
    }
    const el = document.createElement('style');
...
function Button({
  ...
  useStyles();
  const Tag = as;
  const cls = ['uvs-btn', `uvs-btn--${variant}`, `uvs-btn--${size}`, fullWidth ? 'uvs-btn--full' : '', className].filter(Boolean).join(' ');
...
function useStyles() {
  React.useEffect(() => {
    if (injected || document.getElementById('uvs-input-css')) {
      injected = true;
      return;
    }
    const el = document.createElement('style');
...
function Input({
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: ['uvs-field', error ? 'uvs-field--error' : '', className].filter(Boolean).join(' ')
  }, label && /*#__PURE__*/React.createElement("label", {
    className: "uvs-field__label",
    htmlFor: fieldId
  }, label, required && /*#__PURE__*/React.createElement("span", {
    className: "uvs-field__req"
  }, "*")), /*#__PURE__*/React.createElement("div", {
    className: "uvs-input-wrap"
  }, iconLeft && /*#__PURE__*/React.createElement("span", {
    className: "uvs-input-wrap__icon"
  }, iconLeft), /*#__PURE__*/React.createElement("input", _extends({
    id: fieldId,
    className: ['uvs-input', iconLeft ? 'uvs-input--icon' : ''].filter(Boolean).join(' '),
    "aria-invalid": !!error
  }, rest))), (error || hint) && /*#__PURE__*/React.createElement("span", {
    className: ['uvs-field__hint', error ? 'uvs-field__hint--error' : ''].filter(Boolean).join(' ')
  }, error || hint));
}
...
window.UVS_SITE.Curriculum = function Curriculum() {
  ...
  const modules = [{
    n: '01',
    t: 'Your first agent loop',
    d: 'Set up Claude Code, give it context, and ship a real change to a real codebase on day one.',
    tag: 'Vibe',
    tv: 'clay'
  }, {
    n: '02',
    t: 'Reading & steering diffs',
    d: 'Stay in control. Learn to review, accept, and redirect the agent without losing the thread.',
    tag: 'Vibe',
    tv: 'clay'
  }, {
    n: '03',
    t: 'Spec-driven development',
    d: 'Write the plan, constraints, and tests first — then let Claude implement against them.',
    tag: 'Spec',
    tv: 'teal'
  }, {
    n: '04',
    t: 'Context engineering',
    d: 'CLAUDE.md, subagents, and the art of giving the model exactly what it needs.',
    tag: 'Spec',
    tv: 'teal'
  }, {
    n: '05',
    t: 'Testing & refactoring',
    d: 'Drive large refactors safely. Use tests as guardrails for autonomous work.',
    tag: 'Spec',
    tv: 'teal'
  }, {
    n: '06',
    t: 'Shipping to production',
    d: 'Reviews, CI, and team workflows. Bring agentic coding to your whole team.',
    tag: 'Team',
    tv: 'neutral'
  }];
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "eyebrow"
  }, "The curriculum \xB7 6 modules \xB7 ~12 hours"), /*#__PURE__*/React.createElement("h2", null, "What you'll learn"), /*#__PURE__*/React.createElement("p", null, "Hands-on from the first minute. You build, we coach, and you leave with workflows you'll use the next day.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, m.d), /*#__PURE__*/React.createElement(Badge, {
    variant: m.tv,
    mono: true
  }, m.tag))))));
};
...
// ui_kits/website/EnrollModal.jsx
try { (() => {
window.UVS_SITE = window.UVS_SITE || {};
window.UVS_SITE.EnrollModal = function EnrollModal({
  onClose
}) {
  const {
    Input,
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    mono: true,
    dot: true
  }, "Saving your seat"), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontSize: 'var(--text-2xl)',
      margin: '4px 0 0'
    }
  }, "Join the next cohort"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: 'var(--color-text-muted)',
      margin: 0,
      fontSize: 15
    }
  }, "Live, remote, capped at ~20. We'll email the schedule and an invoice.")), /*#__PURE__*/React.createElement(Input, {
    label: "Full name",
  ...
  }, "Pick a cohort"), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 8
    }
  }, cohorts.map(c => /*#__PURE__*/React.createElement("label", {
    key: c,
    style: {
      display: 'flex',
      alignItems: 'center',
      ...
      background: cohort === c ? 'var(--color-accent-soft)' : 'var(--color-surface)',
  ...
  }, "Save my seat"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 11.5,
  ...
  }, "No payment today \xB7 14-day refund")) : /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      flexDirection: 'column',
      gap: 16,
  ...
  }, "We saved your seat for ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: 'var(--color-text)'
    }
  }, cohort), ". Check your inbox for the schedule and next steps."), /*#__PURE__*/React.createElement(Button, {
    variant: "secondary",
    onClick: onClose
  }, "Done"))));
};
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/website/EnrollModal.jsx", error: String((e && e.message) || e) }); }

// ui_kits/website/Footer.jsx
try { (() => {
window.UVS_SITE = window.UVS_SITE || {};
window.UVS_SITE.Footer = function Footer({
  onEnroll
}) {
  const {
    Logo,
  ...
  return /*#__PURE__*/React.createElement("footer", null, /*#__PURE__*/React.createElement("section", {
  ...
  }, "Ready to build with Claude Code?"), /*#__PURE__*/React.createElement("p", {
    style: {
      color: 'color-mix(in srgb, var(--sand-50) 88%, transparent)',
      margin: 0,
      fontSize: 16
    }
  }, "Next cohort starts soon. Seats are limited to keep coaching personal.")), /*#__PURE__*/React.createElement("div", {
    style: {
      position: 'relative',
      display: 'flex',
      gap: 12
    ...
    size: "lg",
    onClick: onEnroll
  }, "Save your seat"))))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "Independent, hands-on workshops that teach you to build real software with Claude Code.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 56,
      flexWrap: 'wrap'
    }
  }, col('Course', ['Curriculum', 'Pricing', 'For teams', 'Schedule']), col('Company', ['About', 'Instructors', 'Blog', 'Contact']), col('Legal', ['Privacy', 'Terms', 'Refunds']))), /*#__PURE__*/React.createElement("div", {
    style: {
  ...
  }, "\xA9 2026 Uber Vibe and Spec \xB7 Not affiliated with Anthropic."), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 12,
      color: 'var(--color-text-subtle)'
...
try { (() => {
window.UVS_SITE = window.UVS_SITE || {};
window.UVS_SITE.Header = function Header({
  onEnroll
}) {
  const {
    Logo,
...
try { (() => {
window.UVS_SITE = window.UVS_SITE || {};
window.UVS_SITE.Hero = function Hero({
  onEnroll
}) {
  const {
    Button,
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    mono: true,
    dot: true
  }, "Live cohorts \xB7 remote"), /*#__PURE__*/React.createElement("h1", {
    style: {
  ...
  }, "From vibe", /*#__PURE__*/React.createElement("br", null), "to spec."), /*#__PURE__*/React.createElement("p", {
    style: {
  ...
  }, "Learn to build real software with Claude Code \u2014 by feel, then by spec. A hands-on workshop for developers and teams who want to ship."), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 12,
      marginTop: 6
    ...
    size: "lg",
    onClick: onEnroll
  }, "Save your seat"), /*#__PURE__*/React.createElement(Button, {
    size: "lg",
    variant: "secondary",
    iconRight: /*#__PURE__*/React.createElement("i", {
      "data-lucide": "arrow-right"
    })
  }, "View syllabus")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      alignItems: 'center',
      gap: 10,
  ...
  }), "2,400+ engineers trained \xB7 4.9/5 average")), /*#__PURE__*/React.createElement("div", {
    className: "reveal",
    style: {
      animationDelay: '90ms'
    }
    ...
    lines: [{
      kind: 'comment',
      text: '# day one — your first agent loop'
    }, {
      kind: 'cmd',
      text: 'claude "add a coupon code field to checkout"'
    }, {
      kind: 'claude',
      text: 'Reading the checkout flow… I\'ll add the field, validation, and a test.'
    }, {
      kind: 'output',
      text: '  edited  src/Checkout.tsx'
    }, {
      kind: 'output',
      text: '  added   src/Checkout.test.tsx'
    }, {
      kind: 'success',
      text: '✓ 3 tests passing · ready to review'
    }],
    cursor: true
  })))));
};
...
try { (() => {
window.UVS_SITE = window.UVS_SITE || {};
window.UVS_SITE.Pricing = function Pricing({
  onEnroll
}) {
  const {
    Button,
  ...
  const tiers = [{
    ...
    price: '$490',
    unit: '/ seat',
    blurb: 'For one developer leveling up.',
    cta: 'Save your seat',
    variant: 'secondary',
    featured: false,
    ...
    price: '$390',
    unit: '/ seat',
    blurb: 'For squads adopting Claude Code together.',
    cta: 'Bring your team',
    variant: 'primary',
    featured: true,
    ...
    price: 'Custom',
    unit: '',
    blurb: 'For org-wide rollouts and enablement.',
    cta: 'Talk to us',
    variant: 'secondary',
    featured: false,
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "eyebrow"
  }, "Pricing"), /*#__PURE__*/React.createElement("h2", null, "Pick a way in"), /*#__PURE__*/React.createElement("p", null, "Every cohort is live, remote, and capped so you get real coaching \u2014 not a video to watch alone.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(3,1fr)',
      gap: 'var(--space-5)',
...
window.UVS_SITE.Quote = function Quote() {
  return /*#__PURE__*/React.createElement("section", {
    ...
    src: "../../assets/motif-vibe-to-spec.svg",
    "aria-hidden": "true",
    style: {
      position: 'absolute',
      inset: 0,
  ...
  }, "\u201CI came in able to prompt my way to a demo. I left able to ship a feature to production \u2014 spec, tests, and review \u2014 without babysitting every line.\u201D"), /*#__PURE__*/React.createElement("footer", {
    style: {
      marginTop: 28,
      display: 'flex',
      flexDirection: 'column',
  ...
  }, "Priya N."), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: 'var(--font-mono)',
      fontSize: 12.5,
...
window.UVS_SITE.Thesis = function Thesis() {
  ...
  return /*#__PURE__*/React.createElement("section", {
    ...
    className: "eyebrow"
  }, "The two modes of building with AI"), /*#__PURE__*/React.createElement("h2", null, "Great builders move fluidly between them."), /*#__PURE__*/React.createElement("p", null, "Our whole curriculum lives in the tension between feeling your way forward and engineering with intent.")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: 'flex',
      gap: 'var(--space-5)',
      alignItems: 'stretch'
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "ui_kits/website/Thesis.jsx", error: String((e && e.message) || e) }); }
...
(function () {
  function App() {
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      onEnroll: open
    }), /*#__PURE__*/React.createElement(S.Thesis, null), /*#__PURE__*/React.createElement(S.Curriculum, null), /*#__PURE__*/React.createElement(S.Pricing, {
      onEnroll: open
    }), /*#__PURE__*/React.createElement(S.Quote, null), /*#__PURE__*/React.createElement(S.Footer, {
      onEnroll: open
    }), enroll && /*#__PURE__*/React.createElement(S.EnrollModal, {
      onClose: close
    }));
  }
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "workshop/deck-stage.js", error: String((e && e.message) || e) }); }

// workshop/tweaks-panel.jsx
try { (() => {
// @ds-adherence-ignore -- omelette starter scaffold (raw elements/hex/px by design)
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "workshop/tweaks-panel.jsx", error: String((e && e.message) || e) }); }
